...
describe('Triangle', () => {
    test('should render shape according to correct color and points mapped', () =>{
        ...
        expect(triangle.render()).toEqual(`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="300" height="200"><polygon points="150, 18 244, 182 56, 182" fill="${shapeColor}" /><text x="150" y="125" font-size="40" text-anchor="middle" fill="${textColor}">${text}</text></svg>`);
    });
});
